...
const App = (function () {
    ...
    const sidebarMainResize = function () {
        ...
        const sidebarMainElement = document.querySelector(".sidebar-main"),
            sidebarMainToggler = document.querySelectorAll(
                ".sidebar-main-resize"
            ),
    ...
    const sidebarMainToggle = function () {
        // Elements
        const sidebarMainElement = document.querySelector(".sidebar-main"),
            sidebarMainRestElements = document.querySelectorAll(
                ".sidebar:not(.sidebar-main):not(.sidebar-component)"
            ),
            sidebarMainDesktopToggler = document.querySelectorAll(
                ".sidebar-main-toggle"
            ),
            sidebarMainMobileToggler = document.querySelectorAll(
    ...
    const sidebarSecondaryToggle = function () {
        ...
        const sidebarSecondaryElement =
                document.querySelector(".sidebar-secondary"),
            sidebarSecondaryRestElements = document.querySelectorAll(
                ".sidebar:not(.sidebar-secondary):not(.sidebar-component)"
            ),
            sidebarSecondaryDesktopToggler = document.querySelectorAll(
                ".sidebar-secondary-toggle"
            ),
            sidebarSecondaryMobileToggler = document.querySelectorAll(
        ...
        sidebarSecondaryMobileToggler.forEach(function (toggler) {
            toggler.addEventListener("click", function (e) {
                e.preventDefault();
                sidebarSecondaryElement.classList.toggle(
    ...
    const sidebarRightToggle = function () {
        ...
        const sidebarRightElement = document.querySelector(".sidebar-end"),
            sidebarRightRestElements = document.querySelectorAll(
                ".sidebar:not(.sidebar-end):not(.sidebar-component)"
            ),
            sidebarRightDesktopToggler = document.querySelectorAll(
                ".sidebar-end-toggle"
            ),
            sidebarRightMobileToggler = document.querySelectorAll(
        ...
        sidebarRightMobileToggler.forEach(function (toggler) {
            toggler.addEventListener("click", function (e) {
                e.preventDefault();
                sidebarRightElement.classList.toggle(
                    sidebarMobileExpandedClass
                );
    ...
    const sidebarComponentToggle = function () {
        ...
        const sidebarComponentElement =
            ...
            sidebarComponentMobileToggler = document.querySelectorAll(
        ...
        sidebarComponentMobileToggler.forEach(function (toggler) {
            toggler.addEventListener("click", function (e) {
                e.preventDefault();
                sidebarComponentElement.classList.toggle(
                    sidebarMobileExpandedClass
                );
            });
        });
    ...
    const navigationSidebar = function () {
        ...
        const navContainerClass = "nav-sidebar",
            ...
            sidebarNavElement = document.querySelectorAll(
            ...
            nav.querySelectorAll(
                ...
                link.addEventListener("click", function (e) {
                    ...
                    if (
                        ...
                        for (let sibling of link.parentNode.parentNode
                            .children) {
                            if (
    ...
    const componentPopover = function () {
        ...
        // Initialize all popovers and store them in an array
        const popovers = Array.from(popoverElements).map(
            (el) =>
        ...
        // Close all popovers on any click outside
        document.addEventListener("click", function (event) {
            popovers.forEach((popover) => {
                // Check if popover element exists and if the click is outside the popover trigger
                if (
                    popover._element &&
    ...
    const componentToTopButton = function () {
        ...
        if (scrollableContainer) {
            ...
            const to_top_button = document.querySelector(".btn-to-top"),
                add_class_on_scroll = () =>
                    to_top_button.classList.add("btn-to-top-visible"),
                remove_class_on_scroll = () =>
                    to_top_button.classList.remove("btn-to-top-visible");
            ...
            scrollableContainer.addEventListener("scroll", function () {
                ...
                if (footerContainer) {
                    if (
                        ...
                        to_top_button.style.bottom =
                            footerContainer.clientHeight + 20 + "px";
                    } else {
    ...
    const cardActionReload = function () {
        ...
        document.querySelectorAll(buttonClass).forEach(function (button) {
            button.addEventListener("click", function (e) {
                ...
                overlayElementIcon.classList.add(
                    spinnerClass,
                    "spinner",
                    "text-body"
                );
            ...
            button.addEventListener("click", function (e) {
                ...
                const parentContainer = button.closest(".card"),
                    collapsibleContainer =
                        parentContainer.querySelectorAll(":scope > .collapse");
        ...
        document.querySelectorAll(buttonAttribute).forEach(function (button) {
            button.addEventListener("click", function (e) {
                ...
                if (!cardFullscreen.classList.contains(cardFullscreenClass)) {
                    ...
                    cardFullscreen
                        .querySelectorAll(`:scope > .${collapsedClass}`)
                        .forEach(function (collapsedElement) {
                            collapsedElement.classList.remove("show");
                        });
                    document
                        .querySelector(`.${scrollableContainerClass}`)
                        .classList.remove("overflow-hidden");
                    button
                        .closest(`.${buttonContainerClass}`)
                        .querySelectorAll(
                            `:scope > .${buttonClass}:not(${buttonAttribute})`
                        )
            ...
            document
                ...
                .forEach(function (link) {
                    link.addEventListener("click", function (e) {
                        ...
                        // Toggle classes
                        link.closest(`.${submenuClass}`).classList.toggle(
                            showClass
                        );
                        link.closest(`.${submenuClass}`)
